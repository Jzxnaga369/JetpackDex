...
fun TransferScreen(
    ...
    Column(
        ...
        Image(
            painter = painterResource(id = R.drawable.transfer_illustration),
        ...
        CustomOutlineTextField(
            ...
            textState = state.recipient,
            onTextChange = {
               viewModel.onEvent(TransferEvent.OnRecipientChange(it))
            },
        ...
        CustomOutlineTextField(
            ...
            onTextChange = {
               viewModel.onEvent(TransferEvent.OnAmountChange(it))
            },
        ...
        PrimaryButton(
            text = "Transfer",
            onClick = {
                viewModel.onEvent(TransferEvent.OnTransfer)
